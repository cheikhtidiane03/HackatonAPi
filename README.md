...
## Ce qu'il reste à faire (bonus du cahier des charges)

- Deadline de soumission (actuellement non bloquée)
- Upload de fichier projet
- Notifications / WebSocket temps réel
- Badge gagnant automatique

⚠️ Je n'ai pas pu compiler ce projet dans mon environnement (pas d'accès à Maven Central en sandbox) —
merci de faire un premier `mvn clean package` de ton côté et de me signaler la moindre erreur, je corrige tout de suite.
